...
const audiences = [
  {
    title: "Issuers & asset owners",
    description:
      "Helping issuers digitize their assets with greater efficiency and transparency.",
    image: "/images/tokenize1.webp",
  },
  {
    title: "Broker-dealers",
    description:
      "Enabling broker-dealers to offer innovative tokenized asset solutions to clients.",
    image: "/images/tokenize2.webp",
  },
  {
    title: "Private corporations",
    description:
      "Modernizing private corporate ownership through secure tokenization.",
    image: "/images/tokenize3.webp",
  },
  {
    title: "Venture capital",
    description:
      "Simplifying the management of venture portfolios with tokenized assets.",
    image: "/images/tokenize4.webp",
  },
  {
    title: "Family offices",
    description:
      "Offering family offices seamless access to diversified tokenized investments.",
    image: "/images/tokenize1.webp",
  },
  {
    title: "Retail investors",
    description:
      "Democratizing access to high-value assets through fractional tokenization.",
    image: "/images/tokenize2.webp",
  },
];
...
function TokenizeCard({
  ...
  return (
    <motion.div
      className="relative aspect-[3/4] w-full flex-shrink-0 cursor-pointer overflow-hidden  bg-gray-50"
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 p-5">
        ...
        <motion.p
          className={`text-sm leading-relaxed transition-colors duration-300 ${isHighlighted ? "text-white/90" : "text-[#444444]"}`}
          animate={{ y: hovered ? 4 : 0 }}
...
export default function Tokenize() {
  const [virtualIndex, setVirtualIndex] = useState(audiences.length);
  ...
  const norm = (v: number) =>
    ((v % audiences.length) + audiences.length) % audiences.length;
  const currentIndex = norm(virtualIndex);
  const repeated = [...audiences, ...audiences, ...audiences];
  ...
  const onComplete = () => {
    const min = audiences.length;
    const max = audiences.length * 2 - 1;
        ...
        >
          ...
          >
            <motion.span
              ...
              transition={{ duration: 0.3 }}
            />
            <span className="relative z-10">Tokenize Assets</span>
