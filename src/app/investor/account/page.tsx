    ...
    <InvestorLayout>
      <div className="mx-auto max-w-4xl space-y-6 p-4 sm:p-6 lg:p-8">
        ...
        {justSubmitted || pendingReview ? (
          <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-base text-amber-800 dark:border-amber-500/25 dark:bg-amber-500/10 dark:text-amber-200">
        ...
        {verified ? (
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-base text-emerald-800 dark:border-emerald-500/25 dark:bg-emerald-500/10 dark:text-emerald-200">
        ...
        {rejected ? (
          <div className="rounded-2xl border border-rose-200 bg-rose-50 px-5 py-4 text-base text-rose-800 dark:border-rose-500/25 dark:bg-rose-500/10 dark:text-rose-200">
