      ...
      <div className="mx-auto w-full max-w-7xl space-y-5 animate-in fade-in duration-700 sm:space-y-6">
        ...
        <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end sm:gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-1 text-base font-medium text-ui-faint md:text-[15px]">
              Discover new investment opportunities across multiple asset classes
            </p>
          </div>
          <div className="flex shrink-0 items-center gap-2">
            <div className="h-2 w-2 animate-pulse rounded-full bg-primary" />
            <span className="text-sm font-bold text-ui-muted-text">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-ui-border bg-ui-card py-3.5 pl-11 pr-6 text-base font-medium shadow-sm outline-none transition-all focus:ring-4 focus:ring-primary/5 md:py-4 md:text-[15px]"
          />
        </div>
          ...
          <aside className="w-full shrink-0 lg:w-[240px] lg:max-w-[35%] xl:w-64 2xl:w-72">
            <div className="space-y-4 rounded-[20px] border border-ui-border bg-ui-card p-5 shadow-sm lg:sticky lg:top-20 lg:space-y-5 lg:rounded-[24px] lg:p-6">
              <div className="flex items-center justify-between gap-3">
                <h3 className="text-base font-bold uppercase tracking-widest text-ui-strong">
                  Filters
                </h3>
                <button
                  type="button"
              ...
              {(filters?.assetTypes.length ?? 0) > 0 && (
                <div className="space-y-2.5 border-t border-ui-divider pt-4 md:space-y-3">
                  <p className="text-xs font-bold uppercase tracking-widest text-ui-faint md:text-[11px]">
                    Asset Type
                  </p>
                  {filters!.assetTypes.map((item: MarketplaceFilterOption) => (
                    ...
                    >
                      ...
                      <span className="text-base font-medium leading-snug text-ui-body md:text-base">
                        {item.label}
                      </span>
                    </label>
                  ))}
            ...
            {isLoading ? (
              ...
              <div className="rounded-[24px] border border-rose-200 bg-rose-50 p-8 text-center dark:border-rose-500/30 dark:bg-rose-500/10">
                ...
                <button
                  type="button"
                  onClick={() => refetch()}
                  className="mt-4 text-base font-bold text-primary hover:underline"
                >
                  Try again
                </button>
              </div>
