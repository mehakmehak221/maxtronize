          ...
          <div className="divide-y divide-ui-divider">
            {items.map((doc) => {
              ...
              if (doc.url) {
                return (
                  <a
                    ...
                    className="group flex cursor-pointer items-center gap-4 px-5 py-5 transition-colors hover:bg-ui-muted-surface md:gap-6 md:px-8 md:py-6"
                  >
                    {inner}
                  </a>
                );
              ...
              return (
                <div
                  key={doc.id}
                  className="group flex items-center gap-4 px-5 py-5 md:gap-6 md:px-8 md:py-6"
                >
                  {inner}
                </div>
              );
